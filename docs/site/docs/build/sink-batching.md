...
2. A non-empty batch ages past its time threshold and triggers a [time-based flush](#time-based-flushing).
...
For details on configuring each sink, see [Sinks](sinks.md).
