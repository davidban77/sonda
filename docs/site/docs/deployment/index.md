...
the scenarios contain, see [Configuration](../build/index.md).

!!! warning "Read this first"
    [**Endpoints & networking**](../deploy/server.md) covers the rules for `localhost`,
...
-   :material-docker: __[Docker](../deploy/docker.md)__
...
-   :material-kubernetes: __[Kubernetes](../deploy/kubernetes.md)__

    The Helm chart, Deployment + Service shape, health probes, ConfigMap-injected
    scenarios, and cluster-DNS sink URLs.

-   :material-server-network: __[Server API](../deploy/server.md)__
