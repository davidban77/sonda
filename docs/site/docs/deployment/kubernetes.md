...
`ghcr.io/davidban77/sonda:<!--x-release-please-version-->1.12.1<!--x-release-please-end-->` (the chart's `appVersion`). Pin a different version with
...
| `image.tag` | `""` (uses `appVersion`: <!--x-release-please-version-->`1.12.1`<!--x-release-please-end-->) | Image tag to pull |
...
helm upgrade sonda ./helm/sonda --set image.tag=<!--x-release-please-version-->1.12.1<!--x-release-please-end-->
```
